...
CXXFLAGS += -I. -I./include $(PLATFORM_CXXFLAGS) $(OPT) -I/home/chris/prj/hamsterdb/include 
...
BENCHMARKS = db_bench_sqlite3 db_bench_tree_db db_hamster
...
db_hamster: doc/bench/db_hamster.o $(LIBOBJECTS) $(TESTUTIL)
	$(CXX) $(LDFLAGS) doc/bench/db_hamster.o $(LIBOBJECTS) $(TESTUTIL) -o $@ $(LIBS) -L/home/chris/prj/hamsterdb/src/.libs/ -lhamsterdb
